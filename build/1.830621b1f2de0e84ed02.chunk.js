...
/* harmony default export */ var Item_Loadable = (lib_default()({
  loader: function loader() {
    return __webpack_require__.e/* import() */(8).then(__webpack_require__.bind(null, "./app/components/VideoCard/Item/index.js"));
  },
  loading: function loading() {
    return null;
  }
...
function HomePage() {
  ...
  Object(react["useEffect"])(function () {
    ...
    try {
      users["a" /* default */].getUserByAccessToken(UserUtils.getAccessToken()).then(function (res) {
  ...
  }, void 0, _ref2, isLoading ? _ref3 : _jsx('div', {
    className: 'row'
