...
var DayColumnPreview = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "".concat(classNames.day, " ").concat(day), style: {
            backgroundSize: "1px ".concat(2 * rowHeight, "px"),
            width: "calc((100% - 5rem) / ".concat(Object.keys(events).length, ")")
        } }, { children: [jsxRuntime.jsx("div", __assign({ className: classNames.day_title, style: { height: "".concat(rowHeight, "px") } }, { children: getDayLabel(day) })), EventsList({
                events: events,
                day: day,
...
var TimeTable = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classNames.time_table_wrapper, style: style, ref: ref }, { children: [jsxRuntime.jsxs("div", __assign({ className: classNames.day }, { children: [jsxRuntime.jsx("div", __assign({ className: classNames.day_title, style: { height: "".concat(rowHeight, "px") } }, { children: timeLabel })), HoursList({ hoursInterval: hoursInterval, renderHour: renderHour, rowHeight: rowHeight })] })), Object.keys(events).map(function (day, index) {
